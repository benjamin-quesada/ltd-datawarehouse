...
[tstp_passing_time_hr] [nvarchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[tstp_passing_time_min] [nvarchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[record_created_date] [datetime2] NOT NULL DEFAULT (sysdatetime()),
[record_updated_date] [datetime2] NULL
)
GO
CREATE CLUSTERED INDEX [ix_avl_trip_filedate_trp_number_trp_op_days] ON [hastus].[avl_trp] ([filedate], [trp_number], [trp_operating_days])
GO
