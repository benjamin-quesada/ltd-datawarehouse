CREATE TABLE [eam].[work_order_detail]
(
[work_order_detail_key] [bigint] NOT NULL IDENTITY(1, 1),
...
[is_road_call] [bit] NOT NULL CONSTRAINT [DF__work_orde__is_ro__02388D9C] DEFAULT ((0)),
...
[record_created_date] [datetime2] NOT NULL CONSTRAINT [DF__work_orde__recor__032CB1D5] DEFAULT (sysdatetime()),
