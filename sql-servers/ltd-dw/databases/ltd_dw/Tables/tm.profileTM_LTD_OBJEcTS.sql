CREATE TABLE [tm].[profileTM_LTD_OBJEcTS]
(
...
GO
ALTER TABLE [tm].[profileTM_LTD_OBJEcTS] ADD CONSTRAINT [PK__profileT__AAAC09D861277E60] PRIMARY KEY CLUSTERED ([RowNumber]) ON [PRIMARY]
GO
