CREATE TABLE [eam].[z WorkOrderDetail 20260304]
(
...
GO
ALTER TABLE [eam].[z WorkOrderDetail 20260304] ADD CONSTRAINT [PK_WorkOrderDetail] PRIMARY KEY CLUSTERED ([woDetailKey]) ON [PRIMARY]
GO
