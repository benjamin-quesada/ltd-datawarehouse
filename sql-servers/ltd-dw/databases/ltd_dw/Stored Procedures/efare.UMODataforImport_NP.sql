...
CREATE   PROCEDURE [efare].[UMODataforImport_NP] 
@yyyymm varchar(32) ,
...
grant execute on efare.[UMODataforImport_NP] to rpt_reader

AUTHOR:  B. EICHBERGER
CREATED: 20230406
TICKET:  RID 17212

example: exec efare.[UMODataforImport_NP] '202307',.75
...
FROM (
	...
	where resellerShortName like 'NP%'
