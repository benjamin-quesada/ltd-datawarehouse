...
CREATE   PROCEDURE [process].[station_graphics_xml] as
...
--
--						exec [process].[station_graphics_xml]
-- =============================================
--
...
DROP TABLE IF EXISTS rpt.station_graphics_xml
CREATE TABLE rpt.station_graphics_xml (sg_text XML)
INSERT rpt.station_graphics_xml (sg_text)
SELECT @sg_xml

--SELECT sg_text FROM rpt.station_graphics_xml
