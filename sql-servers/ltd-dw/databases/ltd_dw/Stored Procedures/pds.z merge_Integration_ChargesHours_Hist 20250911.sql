...
CREATE PROCEDURE [pds].[z merge_Integration_ChargesHours_Hist 20250911]
AS
/*-----------LTD_GLOSSARY---------------
created by	:  b. eichberger
created dt	:  2024-07-30
purpose		:  merge Integration_ChargesHour history file from ph_charges - PDS
use			:  exec [pds].[merge_Integration_ChargesHours_Hist]
...
DECLARE @prg varchar(90) = @@SERVERNAME + '.ltd_dw.pds.merge_Integration_ChargesHours_Hist: ' + CAST(@allCount AS VARCHAR(12))
