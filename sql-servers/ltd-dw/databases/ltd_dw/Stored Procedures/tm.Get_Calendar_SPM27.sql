...
CREATE   PROCEDURE [tm].[Get_Calendar_SPM27]
as
-- =============LTD_GLOSSARY================================
-- Author:		B. Eichberger
...
-- Exec Sample: exec [tm].[Get_Calendar_SPM27]
-- =============================================
...
if (select count(*) from sys.tables where name = 'DW_CALENDAR_SPM27') = 0
BEGIN
...
--truncate table [LTD_DW].[tm].[DW_CALENDAR_SPM27]
...
AND NOT EXISTS (SELECT 1 FROM tm.DW_CALENDAR_SPM27 WHERE CALENDAR_ID = d.calendar_id)
) a
