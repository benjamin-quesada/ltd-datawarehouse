...
CREATE view [tm].[ontime_performance_v]
...
PURPOSE  :  Available for review of data as translated through the legacy model and 
			Reporting.[tm].[VIEW_STORE_ADH_v] 
			
			Official on time performance sources are:
