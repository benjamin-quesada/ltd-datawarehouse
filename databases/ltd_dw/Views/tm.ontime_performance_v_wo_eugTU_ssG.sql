...
CREATE view [tm].[ontime_performance_v_wo_eugTU_ssG]
...
PURPOSE  :  Source of data for analysis, comparisons, general	
...
select [svc]		= a.svc
	...
	from Reporting.[tm].[VIEW_STORE_ADH_v] a
	  ...
	  and a.stop_name not in ('Eugene Station, Bay T','Eugene Station, Bay U', 'Springfield Station, Bay G')
