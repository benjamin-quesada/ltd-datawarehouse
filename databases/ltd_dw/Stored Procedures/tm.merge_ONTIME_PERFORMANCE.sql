...
CREATE   PROCEDURE [tm].[merge_ONTIME_PERFORMANCE]
AS
/*-----------LTD_GLOSSARY---------------
...
UPDATED BY:	Sopheap Suy
UPDATED DT:  04/17/2025
purpose	  :	process only 60 days of data instead of 3 years
			move ontime to update instead of ON statement in merge process
			*/
...
SELECT * 
INTO #ot60
FROM ltd_dw.tm.[ontime_performance_v]
