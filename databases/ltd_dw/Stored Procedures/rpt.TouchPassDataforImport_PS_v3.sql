...
CREATE   PROCEDURE [rpt].[TouchPassDataforImport_PS_v3] 
@yyyymm varchar(32) ,
...
grant execute on [rpt].[TouchPassDataforImport_PS_v2]  to rpt_reader

AUTHOR:  B. EICHBERGER
CREATED: 20200720
TICKET:  RID 10100

example: exec rpt.[TouchPassDataforImport_PS] '202107',0
...
--DECLARE @yyyymm INT = 202211, @nonprofitDiscount DECIMAL(3, 3) = 0
...
FROM (
	...
	FROM ltd_dw.rpt.TouchPassSales
	WHERE reseller like 'PS%'
...
INSERT #importPS_EDEN_fileData_PS  ( [cust_no]
      ,[inv_no]
      ,[Dt1]
      ,[Service_Type]
      ,[line_no]
