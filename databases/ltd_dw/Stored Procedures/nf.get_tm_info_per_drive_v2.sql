...
CREATE PROCEDURE [nf].[get_tm_info_per_drive_v2]
AS

/************************************************
CREATED BY  : B Eichberger
CREATED DT  : 20220922
CREATED FOR : copy from original get_tm_info_per_drive
			  and point to new views that combine new and legacy
			  download tables for parameters and events
			  load tm matching data into table for NF Model

exec nf.get_tm_info_per_drive_v2 
*************************************************/
