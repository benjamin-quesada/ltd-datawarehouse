CREATE TABLE [tm].[ONTIME_PERFORMANCE_wo_arr_ann_stations]
(
[ontime_performance_wo_arr_ann_stations_key] [bigint] NOT NULL IDENTITY(1, 1),
...
[report_created_date] [datetime2] NOT NULL CONSTRAINT [DF__ONTIME_PE__repor__6AC7EB03] DEFAULT (sysdatetime()),
[report_updated_date] [datetime2] NULL
) ON [PRIMARY]
GO
ALTER TABLE [tm].[ONTIME_PERFORMANCE_wo_arr_ann_stations] ADD CONSTRAINT [PK_ONTIME_PERFORMANCE_wo_arr_ann_stations] PRIMARY KEY CLUSTERED ([ontime_performance_wo_arr_ann_stations_key]) ON [PRIMARY]
GO
