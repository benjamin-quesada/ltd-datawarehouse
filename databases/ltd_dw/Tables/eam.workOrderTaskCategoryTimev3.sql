CREATE TABLE [eam].[workOrderTaskCategoryTimev3]
(
...
[unique_id] [varchar] (28) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[record_created_date] [datetime2] NULL CONSTRAINT [DF__workOrder__recor__0A0DBC6D] DEFAULT (sysdatetime()),
[record_updated_date] [datetime2] NULL
) ON [PRIMARY]
GO
ALTER TABLE [eam].[workOrderTaskCategoryTimev3] ADD CONSTRAINT [PK_workOrderTaskCategoryTimev3] PRIMARY KEY CLUSTERED ([work_key]) ON [PRIMARY]
GO
