CREATE TABLE [efare].[stage_FARE_Extended]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_stage_FARE_Extended_cardNumber_accountId] ON [efare].[stage_FARE_Extended] ([cardNumber], [accountId]) ON [PRIMARY]
GO
