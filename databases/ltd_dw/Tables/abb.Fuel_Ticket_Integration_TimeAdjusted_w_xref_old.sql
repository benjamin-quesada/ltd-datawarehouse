CREATE TABLE [abb].[Fuel_Ticket_Integration_TimeAdjusted_w_xref_old]
(
...
[record_created_date] [datetime2] NOT NULL CONSTRAINT [DF_FTI_TimeAdjusted_w_xref_record_created_date] DEFAULT (sysdatetime()),
