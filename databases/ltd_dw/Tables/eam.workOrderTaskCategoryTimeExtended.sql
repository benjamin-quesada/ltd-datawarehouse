CREATE TABLE [eam].[workOrderTaskCategoryTimeExtended]
(
...
[record_created_date] [datetime2] NULL CONSTRAINT [DF__workOrder__recor__00E908F0] DEFAULT (sysdatetime()),
[record_updated_date] [datetime2] NULL,
[row_id] [int] NULL,
[group_row_id] [int] NULL
) ON [PRIMARY]
GO
ALTER TABLE [eam].[workOrderTaskCategoryTimeExtended] ADD CONSTRAINT [PK_workOrderTaskCategoryTimeExtended] PRIMARY KEY CLUSTERED ([work_key]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_eam_workOrderTaskCategoryTimeExtended_70] ON [eam].[workOrderTaskCategoryTimeExtended] ([calendar_id]) ON [PRIMARY]
GO
