CREATE TABLE [eam].[workOrderTaskCategoryTimeExtended_new]
(
...
[life_miles] [int] NULL,
[ltd_bus_class] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[record_created_date] [datetime2] NULL CONSTRAINT [DF__workOrder__recor__17BCEF10] DEFAULT (sysdatetime()),
[record_updated_date] [datetime2] NULL,
[row_id] [int] NULL,
[group_row_id] [int] NULL,
[is_road_call] [bit] NOT NULL CONSTRAINT [DF__workOrder__is_ro__16C8CAD7] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [eam].[workOrderTaskCategoryTimeExtended_new] ADD CONSTRAINT [PK_workOrderTaskCategoryTimeExtended_new] PRIMARY KEY CLUSTERED ([work_key]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_eam_workOrderTaskCategoryTimeExtended_new] ON [eam].[workOrderTaskCategoryTimeExtended_new] ([calendar_id]) ON [PRIMARY]
GO
